 ...
 * @license MIT License
 * @author Cihat Alkis <cihatalkis@icloud.com.com>
...
return [
    ...
    'exceptions' => [
        ...
        '0' => 'VatanSoft auth parametresi ayarlarda tanımlanmamış!',
        '1' => 'VatanSoft Auth User and Password are not set correctly!',
        '2' => 'VatanSoft Default sender (originator) is not set!',
