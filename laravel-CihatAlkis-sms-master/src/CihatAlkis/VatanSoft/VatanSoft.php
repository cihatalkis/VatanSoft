 ...
 * @license MIT License
 * @author Cihat Alkış <cihadaklis@icloud.com>
 * @link https://cihatalkis@
 *
 */
...
class VatanSoft
{
    ...
    /**
     * The method that creates a XML string to send to Vatansoft API
    ...
    public function sendBulk($recipients, $message = '', $date = '', $senderID = '')
    {
        ...
        return $this->postXML($xml, 'http://www.vatansoft.com.tr');
    }
    ...
    public function send($receiver, $message = '', $date = '', $senderID = '')
    {
        ...
        return $this->postXML($xml, 'https://www.vatansoft.com.tr');
    }
    ...
    {
        //If the <nums> parameter is blank, all users are removed from blacklist as VatanSoft Api says
    ...
    public function checkBalance()
    {
        ...
        $response = $this->postXML($xml, 'https://www.vatansoft.com.tr');
    ...
    public function listOriginators()
    {
        ...
        return $this->postXML($xml, 'https://https://www.vatansoft.com.tr');
    }
    ...
    public function getMessageReport($messageId)
    {
        ...
        $result = $this->postXML($xml, 'https://https://www.vatansoft.com.tr');
